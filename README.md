...
Docs live in `docs/` and are maintained as Godot project references. Legacy HTML filenames are retained for link stability, but their contents should reflect the current Godot game. New agents should start with `docs/agent-onboarding-checklist.md`, `docs/agent-codebase-map.md`, `docs/main-gd-ownership-map.md`, `docs/ui-runtime-boundary-map.md`, `docs/activity-ui-boundary-map.md`, and `docs/generated-file-hygiene.md` before broad refactors.
