...
| `scripts/` | 196 files / about 111,428 text lines | Game runtime script, UI drawing helpers, validation, build, and maintenance scripts. |
...
| --- | ---: | --- |
| `scripts/main.gd` * | 66,691 | Monolithic game controller: save/load, activity data, skill UI, navigation, fishing, leaderboard, chat, hub, audio, and most orchestration. Primary deletion/refactor target; recent UI drawing controls now preload from `scripts/ui/`. |
