...
- Play upload bundle: `builds/android/idle-elite-release-v0.1.11-code12.aab`
- Bundletool test package: `builds/android/idle-elite-release-v0.1.11-code12.apks`
...
- Repeatable release build process: `docs/play-store/release-build-process.md`
...
- Release manifest reports `versionCode=12`, `versionName=0.1.11`, `minSdk=24`, and `targetSdk=35`.
...
4. Upload `builds/android/idle-elite-release-v0.1.11-code12.aab`.
5. Store listing:
