...
- Play upload bundle: `builds/android/idle-elite-release-v0.1.8-code9.aab`
- Bundletool test package: `builds/android/idle-elite-release-v0.1.8-code9.apks`
...
- Installed release package reports `versionCode=9`, `versionName=0.1.8`, `minSdk=24`, and `targetSdk=35`.
...
4. Upload `builds/android/idle-elite-release-v0.1.8-code9.aab`.
5. Store listing:
