...
- Verify `builds/android/idle-elite-release-v0.1.11-code12.aab` exists.
- Run `jarsigner -verify builds\android\idle-elite-release-v0.1.11-code12.aab`.
...
- Upload `builds/android/idle-elite-release-v0.1.11-code12.aab`.
