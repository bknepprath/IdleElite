...
| Chat presentation | `_build_chat_strip`, `_build_chat_overlay`, `_chat_strip_visible_on_current_screen`, `_chat_expanded_row`, `_chat_expanded_composer` | Owns the collapsed strip, expanded overlay, unread display, and mobile keyboard behavior. |
