...
- **Agent orientation:** Start with `agent-codebase-map.md`, `main-gd-ownership-map.md`, and `ui-runtime-boundary-map.md` before broad code, asset, UI, or validation changes.
