...
| Passive/convergence modules | `passive_modules`, `convergence_modules`, `_process_passive_modules`, `_convergence_runtime()`, convergence state property bridges, related save helpers | `.\scripts\test-save-normalization.ps1`, `.\scripts\test-performance-regressions.ps1` |
