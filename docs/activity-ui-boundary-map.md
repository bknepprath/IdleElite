...
| Unlocks and lockpads | `_unlock_prior_test_actions`, `_unlock_padlock_pulse_texture`, `_unlock_padlock_tint_mask_texture`, `_action_has_pending_unlock_readiness`, `_apply_pending_activity_unlock_readiness` | Unlock UI touches manual unlock state, pending ceremony state, and auto-unlock behavior. |
