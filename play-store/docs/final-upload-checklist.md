...
- Verify `builds/android/idle-elite-release-v0.3.0-code20.aab` exists.
- Run `jarsigner -verify builds\android\idle-elite-release-v0.3.0-code20.aab`.
...
- Upload `builds/android/idle-elite-release-v0.3.0-code20.aab`.
