...
- Verify `builds/android/idle-elite-release-v0.3.2-code22.aab` exists.
- Run `jarsigner -verify builds\android\idle-elite-release-v0.3.2-code22.aab`.
...
- Upload `builds/android/idle-elite-release-v0.3.2-code22.aab`.
