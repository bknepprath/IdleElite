...
- Verify `builds/android/idle-elite-release-v0.3.1-code21.aab` exists.
- Run `jarsigner -verify builds\android\idle-elite-release-v0.3.1-code21.aab`.
...
- Upload `builds/android/idle-elite-release-v0.3.1-code21.aab`.
