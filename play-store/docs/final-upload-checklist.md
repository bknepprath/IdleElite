...
- Verify `builds/android/idle-elite-release-v0.2.1-code15.aab` exists.
- Run `jarsigner -verify builds\android\idle-elite-release-v0.2.1-code15.aab`.
...
- Upload `builds/android/idle-elite-release-v0.2.1-code15.aab`.
