...
- Verify `builds/android/idle-elite-release-v0.4.3-code23.aab` exists.
- Run `jarsigner -verify builds\android\idle-elite-release-v0.4.3-code23.aab`.
...
- Upload `builds/android/idle-elite-release-v0.4.3-code23.aab`.
