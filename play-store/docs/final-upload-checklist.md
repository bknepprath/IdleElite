...
- Verify `builds/android/idle-elite-release-v0.4.6-code29.aab` exists.
- Run `jarsigner -verify builds\android\idle-elite-release-v0.4.6-code29.aab`.
...
- Upload `builds/android/idle-elite-release-v0.4.6-code29.aab`.
