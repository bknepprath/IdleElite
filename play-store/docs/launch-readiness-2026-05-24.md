...
- `play-store/assets/app-icon-512.png`: 512 x 512 PNG, 580.7 KB.
- `play-store/assets/feature-graphic-1024x500.png`: 1024 x 500 PNG, 134.2 KB.
- `play-store/assets/screenshot-01-train-five-skills-1080x1920.png`: 1080 x 1920 PNG.
- `play-store/assets/screenshot-02-stamina-choices-1080x1920.png`: 1080 x 1920 PNG.
- `play-store/assets/screenshot-03-level-up-1080x1920.png`: 1080 x 1920 PNG.
- `play-store/assets/screenshot-04-offline-progress-1080x1920.png`: 1080 x 1920 PNG.
- `play-store/assets/screenshot-05-idle-elitist-1080x1920.png`: 1080 x 1920 PNG.

## Launch Blockers

- Replace `TODO` developer name and contact email in `play-store/docs/privacy-policy-draft.md`, host the policy publicly, and paste its URL into Play Console.
