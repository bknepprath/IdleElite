...
- Play upload bundle: `builds/android/idle-elite-release-v0.2.0-code14.aab`
- Bundletool test package: `builds/android/idle-elite-release-v0.2.0-code14.apks`
...
- Release manifest reports `versionCode=14`, `versionName=0.2.0`, `minSdk=24`, and `targetSdk=35`.
...
4. Upload `builds/android/idle-elite-release-v0.2.0-code14.aab`.
5. Store listing:
