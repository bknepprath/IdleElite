...
- Play upload bundle: `builds/android/idle-elite-release-v0.2.2-code19.aab`
- Bundletool test package: `builds/android/idle-elite-release-v0.2.2-code19.apks`
...
- Release manifest reports `versionCode=19`, `versionName=0.2.2`, `minSdk=24`, and `targetSdk=35`.
...
4. Upload `builds/android/idle-elite-release-v0.2.2-code19.aab`.
5. Store listing:
