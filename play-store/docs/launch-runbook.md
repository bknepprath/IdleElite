...
- Play upload bundle: `builds/android/idle-elite-release-v0.1.12-code13.aab`
- Bundletool test package: `builds/android/idle-elite-release-v0.1.12-code13.apks`
...
- Release manifest reports `versionCode=13`, `versionName=0.1.12`, `minSdk=24`, and `targetSdk=35`.
...
4. Upload `builds/android/idle-elite-release-v0.1.12-code13.aab`.
5. Store listing:
