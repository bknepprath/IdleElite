...
- Play upload bundle: `builds/android/idle-elite-release-v0.3.2-code22.aab`
- Bundletool test package: `builds/android/idle-elite-release-v0.3.2-code22.apks`
...
- Release manifest reports `versionCode=22`, `versionName=0.3.2`, `minSdk=24`, and `targetSdk=35`.
...
4. Upload `builds/android/idle-elite-release-v0.3.2-code22.aab`.
5. Store listing:
