...
- Play upload bundle: `builds/android/idle-elite-release-v0.2.12-code17.aab`
- Bundletool test package: `builds/android/idle-elite-release-v0.2.12-code17.apks`
...
- Release manifest reports `versionCode=17`, `versionName=0.2.12`, `minSdk=24`, and `targetSdk=35`.
...
4. Upload `builds/android/idle-elite-release-v0.2.12-code17.aab`.
5. Store listing:
