...
- Play upload bundle: `builds/android/idle-elite-release-v0.4.41-code25.aab`
- Bundletool test package: `builds/android/idle-elite-release-v0.4.41-code25.apks`
...
- Release manifest reports `versionCode=25`, `versionName=0.4.41`, `minSdk=24`, and `targetSdk=35`.
...
4. Upload `builds/android/idle-elite-release-v0.4.41-code25.aab`.
5. Store listing:
