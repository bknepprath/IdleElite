...
- Play upload bundle: `builds/android/idle-elite-release-v0.4.3-code23.aab`
- Bundletool test package: `builds/android/idle-elite-release-v0.4.3-code23.apks`
...
- Release manifest reports `versionCode=23`, `versionName=0.4.3`, `minSdk=24`, and `targetSdk=35`.
...
4. Upload `builds/android/idle-elite-release-v0.4.3-code23.aab`.
5. Store listing:
