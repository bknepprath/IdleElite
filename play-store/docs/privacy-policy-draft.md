# Idle Elite Privacy Policy Draft
...
This draft is ready to paste into a hosted privacy policy page after replacing the developer contact placeholders.
...
Idle Elite uses Google AdMob to show rewarded ads. Rewarded ads are optional and are shown when you choose to watch an ad for an in-game bonus.

Google AdMob may collect and process advertising identifiers, device information, approximate location inferred from network information, ad interaction data, diagnostics, and other information as described by Google's policies. Google may use this information to provide ads, measure ad performance, prevent fraud and abuse, and comply with legal requirements.
...
Idle Elite is not designed to knowingly collect personal information from children. The Google Play target audience and content rating answers should be completed accurately in Play Console before release.

## Changes

This privacy policy may be updated as the app changes. The effective date will be updated when material changes are made.
