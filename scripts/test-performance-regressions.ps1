...
$leaderboardDropdownStyle = Get-FunctionBody -Text $main -Name "_leaderboard_dropdown_style"
$leaderboardPlayerCardStyle = Get-FunctionBody -Text $main -Name "_leaderboard_player_card_style"
...
Assert-True ($leaderboardDropdownStyle -match 'LeaderboardStyles\.dropdown') "Leaderboard dropdown style construction should live in scripts\leaderboard\styles.gd."
Assert-True ($leaderboardPlayerCardStyle -match 'LeaderboardStyles\.player_card') "Leaderboard player-card style construction should live in scripts\leaderboard\styles.gd."
