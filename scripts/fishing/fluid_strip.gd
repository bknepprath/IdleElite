...
func _setup_fill() -> void:
	...
	var underlay_shader := preload("res://scripts/fishing/fluid_strip_underlay.gdshader") as Shader
	...
	var shader := preload("res://scripts/fishing/fluid_strip.gdshader") as Shader
	if shader != null:
