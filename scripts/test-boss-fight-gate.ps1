...
func _run() -> void:
	...
	_expect(not bool(scene.call("_fighting_runtime").get("completed_bosses").get("rooster", false)), "Rooster should not clear from the normal activity timer")
	...
	_expect(bool(scene.call("_fighting_runtime").get("completed_bosses").get("rooster", false)), "Rooster should be saved as completed after KO")
