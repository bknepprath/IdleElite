...
if ($strictCutover) {
	...
	Assert-True ($achievementSurface -match '(?m)^const OFFLINE_SUMMARY_MODAL_HEIGHT := 720\.0\r?$') "Welcome Back modal must retain a fixed non-scrollable native-1080 height."
